import { TriggerManager, TriggerContext } from '../../src/systems/TriggerManager';
import { GameState, Stats, Choice, Personality, StressState } from '../../src/types';

// Mock personalitySystem
jest.mock('../../src/utils/personalitySystem', () => ({
