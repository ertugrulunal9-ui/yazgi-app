...
export const strings: Record<AppLocale, NestedRecord> = {
  tr: {
    ...
    game: {
      endDay: 'Günü Bitir',
      endDayHint: 'Sıradaki tura gecer',
    ...
    settings: {
      ...
      audioMutedState: 'Tum oyun sesleri kapalı',
      audioEnabledState: 'Müzik ve efektler açık',
      privacy: 'Gizlilik',
      analyticsOptIn: 'Davranis Analitigi',
      analyticsOptInEnabled: 'Paylasim açık',
      analyticsOptInDisabled: 'Paylasim kapalı',
      personalizedAds: 'Kişiselleştirilmiş Reklam',
      personalizedAdsEnabled: 'Kişiselleştirilmiş reklam açık',
      personalizedAdsDisabled: 'Kisisellestirilmemis reklam',
      consentNote: 'İlk açılışta izin ayarladın. Buradan değiştirebilirsin.',
      privacyPolicy: 'Gizlilik Politikası',
      termsOfService: 'Kullanım Koşulları',
      reduceMotion: 'Gecisleri Azalt',
      saves: 'Kayitlar',
      language: 'Dil',
      newLife: 'Yeni Hayata Başla',
      goPremium: 'Yazgı Premium',
      premiumDesc: 'Reklamsız, sınırsız geri al, özel eventler',
      themeOptions: {
        light: 'Açık',
        dark: 'Koyu',
        system: 'Sistem',
    ...
    errors: {
      saveFailed: 'Kayıt başarısız oldu. Tekrar denenecek.',
      loadFailed: 'Kayıt yuklenemedi. Lütfen tekrar dene.',
      genericError: 'Bir hata olustu. Lütfen uygulamayi yeniden baslat.',
    ...
    ui: {
      statusHeader: {
        ...
        stressReliefActionsHint: 'Ipucu: Sosyal sekmesinde NPC etkileşimleri stresi düşürür.',
        dreamComplete: 'Hayalin sana açık!',
        dreamAlmost: 'Hedefe çok yakinsin. Son hamleyi dikkatli yap.',
        ...
        riskOpen: 'Risk Alarmi Açık',
        riskNormal: 'Risk Seviyesi Normal',
        riskCriticalHint: 'Kritik risk! Son hamlen çok onemli.',
        riskIncreasingHint: 'Risk artiyor. Kararlarını yavaşlat.',
        riskNormalHint: 'Risk seviyesi kontrol altinda.',
        moneyFormatK: 'K TL',
        moneyFormat: ' TL',
        openDetails: 'detaylarini aç',
        goalUnlocksAt10: 'Hedef secimi 10 yaşında açılır.',
      ...
      feedbackOverlay: {
        ...
        watchAdRecover: 'Reklam İzle: Kaybin %50sini Geri Al',
      },
    ...
    messages: {
      ...
      examFocusActive: 'Sınav odagi aktif: +{boost} zekâ',
      focusBonusLimitReached: 'Zekâ zaten maksimum, odak bonusu sinirda kaldi',
      examFocusEnded: 'Sınav odak takviyesi sona erdi',
    ...
    dialogs: {
      examPrep: {
        title: 'Sınav Hazirligi',
        description: 'Sınav oncesi reklam izleyip gecici +15 zekâ odagi almak ister misin?',
      },
      outOfEnergy: {
        title: 'Enerjin bitti',
    ...
    feedback: {
      ...
      momentum: {
        ...
        flavor: {
          HELPFUL: 'Yardimsever ruhun güçleniyor!',
          PRAGMATIC: 'Pragmatik ruhun güçleniyor!',
          AGGRESSIVE: 'Agresif ruhun güçleniyor!',
        },
      },
    },
    ...
    endings: {
      ...
      completedAge: '{name} {age} yaşını tamamladi',
      ...
      unexpectedPath: 'Beklenmedik Yol: secilen hedeften farkli olarak {inferred} rotasinda daha güçlü bir profil olusturdun.',
      criticalDebts: 'Kritik borclar: ',
      achievementImpact: 'Basarim Etkisi',
      gainedTraits: 'Kazanilan Ozellikler',
      relationships: 'Iliskiler',
      metAtAge: ' yaşında tanistin',
      friendshipYears: ' yillik dostluk',
      neverMadeUp: 'hiç barismadin',
      legacy: 'Miras',
      runLegacyPoints: 'Bu kosu: +{points} miras puanı',
      ...
      personalities: {
        ...
        AGGRESSIVE: 'Sinirlarini sert cizdi. Bu ona hem güç hem bedel getirdi.',
        DEFAULT: 'Kendi yolunu kendi biciminde yurudu.',
      },
      suggestions: {
        ACADEMIC: '"Sanatci" yolunu denemeyi dusundun mu hiç?',
      ...
      content: {
        flavor: {
          ...
          richLonely: 'Paran var ama etrafinda gercekten guvendigin insanlar çok az.',
          ...
          failureResilience: 'Disiplinli gecmisin, bir sonraki denemede oyunu cevirmen icin güçlü bir temel sunuyor.',
          perfectionist: 'Mukemmeliyetci rutinin bu sonucu bir tesaduf olmaktan çıkardı.',
        },
        mismatch: {
          title: 'Surpriz Kariyer',
          description: '{selectedGoal} hedefini secmistin; hayat cizgin {inferredGoal} yonune açıldı. Yeni rotanda {career} yolunu yakaladin.',
          familyReaction: 'Ailen, rota degisse de doğru ritmi yakaladigini dusunuyor.',
          newRoute: 'Yeni rota: {career}',
        },
        careers: {
          failureUnemployed: {
            title: 'Mezuna Kaldin / Issiz',
            description: 'Sınav sonucun bekledigin gibi gelmedi.',
          ...
          rockstarVirtuoso: {
            ...
            influences: {
              0: 'Müzik notun ({grade}) konservatuar yolunu guclendirdi.',
            },
          },
          medSchool: {
            title: 'Tip Fakultesi',
          ...
          privateUniversityBusiness: {
            title: 'Özel Uni - Isletme',
            description: 'Notlarin parlak olmasa da finansal gucunle iyi bir başlangıç yaptin.',
          ...
          sportsCoach: {
            title: 'Spor Egitmeni',
            description: 'Sabrin ve takim ruhu anlayisin seni genç sporculara yol gosteren bir egitmene donusturdu.',
          ...
          esportsPlayer: {
            ...
            familyReaction: 'Ailen bilgisayar basinda gecirdigin saatlerin sonucunu gormeye başlıyor.',
          },
          stageMusician: {
            title: 'Sahne Muzisyeni',
            description: 'Sahnede parladin; akademik müzik notlarin konservatuar seviyesine cikamadi.',
            familyReaction: 'Ailen sahnede kendini bulmana seviniyor.',
            influences: {
              0: 'Müzik notun ({grade}) akademik yolu sinirladi.',
            },
          },
          artist: {
            title: 'Sanatci',
            description: 'Sergilerin kapalı gise. Eserlerin koleksiyonerler tarafindan kapisiliyor.',
            familyReaction: 'Ailen eserlerini duvarlarina asiyor.',
            influences: {
              0: 'Görsel sanatlar notun ({grade}) sergi kapilarini acti.',
            },
          },
          atelierArtist: {
            ...
            influences: {
              0: 'Görsel sanatlar notun ({grade}) akademik destegi zayiflatti.',
            },
          },
          famousWriter: {
            title: 'Unlu Yazar',
            description: 'Kitaplarin çok satanlar listesinde. Imza gunlerinde uzun kuyruklar var.',
          ...
          teacher: {
            title: 'Ogretmen',
            description: 'Sabrin ve empatin seni genç nesillere bilgi aktaran bir ogretmene donusturdu.',
            familyReaction: 'Ailen ogrencilerinin sevgisini gormeye bayiliyor.',
          },
          versatileProfessional: {
            title: 'Çok Yonlu Profesyonel',
            description: 'Tek bir alana kapanmak yerine birçok beceriyi harmanladin. Farkli sektorlerden teklifler aliyorsun.',
          ...
          economicsPublicAdmin: {
            ...
            description: 'Dengeli bir profil ile universite yolunu açık tuttun.',
            familyReaction: 'Ailen en azindan iyi bir temel kurdugunu dusunuyor.',
          },
          secretTrueBalance: {
            title: 'Gerçek Denge Ustasi',
            description: 'Hayatin her alaninda denge buldun. Bu basari çok az kisiye nasip olur.',
          ...
          secretFamilyLegacy: {
            ...
            familyReaction: 'Ailen: Sen bizim en büyük gururumuzsun.',
          },
          secretFateBreaker: {
            title: 'Kader Kirici',
          ...
          secretSilentLegend: {
            ...
            familyReaction: 'Ailen: O hep kendi halinde ama çok yetenekli diyor.',
          },
        },
        futureVision: {
          defaultName: 'Sen',
          goals: {
            ACADEMIC: {
              at30: {
                v1: '{name}, 30 yaşında arastirma masasinda gecirdigin uzun geceler meyvesini veriyor. Calismalarin seni alaninda guvenilen bir sese donusturuyor.',
                v2: '{name}, 30 yaşında derslik ile laboratuvar arasinda kurdugun denge meyve veriyor. Urettigin fikirler genç zihinlere yeni kapilar aciyor.',
              },
              at50: {
                v1: '{name}, 50 yaşında yetistirdigin ogrenciler senin izini surmeye devam ediyor.',
                v2: '{name}, 50 yaşında adin bilgiyle anilan bir okulun temel taslarindan biri oluyor.',
              },
            },
            CREATIVE: {
              at30: {
                v1: '{name}, 30 yaşında hayal gucun somut projelere dönüşüyor. Eserlerin izleyicilerde iz birakan bir imzaya sahip oluyor.',
                v2: '{name}, 30 yaşında uretim ritmini buluyorsun. Islerin hem duyguyu hem cesareti ayni anda taşıyor.',
              },
              at50: {
                v1: '{name}, 50 yaşında bir kusagin ilham panosunda adini birakmis oluyorsun.',
                v2: '{name}, 50 yaşında eserlerin yeni sanatcilara yol haritasi olarak gösteriliyor.',
              },
            },
            ATHLETIC: {
              at30: {
                v1: '{name}, 30 yaşında disiplinin bedenine ve zihnine ayni anda yansiyor. Rekabetin icinde kalirken etrafina da tempo veriyorsun.',
                v2: '{name}, 30 yaşında antrenman rutinin hayatinin iskeleti oluyor. Zirve yarislari kadar toparlanma gunlerine de değer veriyorsun.',
              },
              at50: {
                v1: '{name}, 50 yaşında birikiminle genç sporculara yol gosteren bir isim haline geliyorsun.',
                v2: '{name}, 50 yaşında performans kadar saglam kalmanin bilgisini paylasiyorsun.',
              },
            },
            SOCIAL: {
              at30: {
                v1: '{name}, 30 yaşında insanlar arasinda kopru kuran bir role geciyorsun. Guven verdigin icin kapilar once sana açılıyor.',
                v2: '{name}, 30 yaşında ilişki agin sadece kalabalik degil, ayni zamanda derin oluyor. Zor anlarda insanlar senden yon buluyor.',
              },
              at50: {
                v1: '{name}, 50 yaşında etrafinda kurdugun guven cemberi hayatinin en büyük sermayesine dönüşüyor.',
                v2: '{name}, 50 yaşında birçok insan seni kriz anlarında ilk aradığı kişi olarak görüyor.',
              },
            },
            ENTERPRISE: {
              at30: {
                v1: '{name}, 30 yaşında risk ile plan arasinda yeni bir denge kuruyorsun. Urettigin değer seni sadece kazanan degil yon veren bir oyuncu yapiyor.',
                v2: '{name}, 30 yaşında firsat kokusunu erken alan bir bakis acisi geliştiriyorsun. Doğru ekiplerle buyumeyi hizlandiriyorsun.',
              },
              at50: {
                v1: '{name}, 50 yaşında kurdugun sistemler senden sonra da islemeye devam ediyor.',
                v2: '{name}, 50 yaşında birikimin hem yatirimlara hem yeni girisimcilere can veriyor.',
              },
            },
            BALANCED: {
              at30: {
                v1: '{name}, 30 yaşında tek bir alana kapanmak yerine hayatini dengede buyutuyorsun. Is, ilişki ve iç huzur arasinda kendi olcunu buluyorsun.',
                v2: '{name}, 30 yaşında farkli rolleri tasirken yorulmadan ilerlemeyi ogreniyorsun. Küçük ama surekli adimlarin büyük bir denge kuruyor.',
              },
              at50: {
                v1: '{name}, 50 yaşında hayatindaki uyum duygusu en güçlü pusulana dönüşüyor.',
                v2: '{name}, 50 yaşında istikrarli yonden sapmadan ilerlemenin degerini çevrendekilere aktariyorsun.',
              },
            },
          },
          tiers: {
            LEGENDARY: {
              ...
              at50: {
                v1: 'Zaman gectikce hikayen bir basari olcusune dönüşüyor.',
                v2: 'Birakilan etki, yillara ragmen azalmadan buyuyor.',
              },
            },
            SUCCESS: {
              at30: {
                v1: 'Istikrarli adimlarin seni saglam bir zirveye taşıyor.',
                v2: 'Hizli sicramalardan çok, guvenilir ilerlemenin gucunu gostermis oluyorsun.',
              },
              at50: {
            ...
            NORMAL: {
              at30: {
                v1: 'Yolun parlak ama ölçülü; fazla risk almadan yavaş yavaş gucleniyorsun.',
                v2: 'Büyük patlamalar yerine duzgun ritim seni ayakta tutuyor.',
              },
              at50: {
            ...
            FAILURE: {
              at30: {
                ...
                v2: 'Bazi kapilar gec açılıyor, bu da yolunu yeniden cizmeye zorluyor.',
              },
              at50: {
  ...
  en: {
    ...
    settings: {
      ...
      consentNote: 'You set this during first launch. You can change it here.',
      ...
      goPremium: 'Yazgi Premium',
      premiumDesc: 'Ad-free, unlimited undo, special events',
      themeOptions: {
        light: 'Light',
        dark: 'Dark',
        system: 'System',
