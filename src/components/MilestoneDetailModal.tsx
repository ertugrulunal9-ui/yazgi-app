                ...
                <View style={styles.modalContainer}>
                    ...
                    <View style={styles.header}>
                        <Text style={styles.headerTitle}>
                            {milestone.skillName} {UI_TEXT.milestoneModal.titleSuffix}
                        </Text>
                    ...
                    <View style={styles.content}>
                        ...
                        <Text style={styles.statusText}>
                            {milestone.unlocked ? UI_TEXT.milestoneModal.statusOpen : UI_TEXT.milestoneModal.statusLocked}
                        </Text>

                        {/* Benefits List */}
                        <View style={styles.benefitContainer}>
                            <Text style={styles.benefitTitle}>{UI_TEXT.milestoneModal.rewards}</Text>
                        ...
                        <TouchableOpacity style={styles.closeButton} onPress={onClose}>
                            <Text style={styles.closeButtonText}>{UI_TEXT.buttons.close}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
