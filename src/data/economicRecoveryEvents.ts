...
export const ECONOMIC_RECOVERY_EVENTS: GameEvent[] = [
  {
    ...
    text: 'Mahalledeki bir eğitim vakfı, ihtiyaç sahibi öğrenciler için burs başvurusu açtı.',
    minAge: 8,
    maxAge: 17,
    rarity: 'UNCOMMON',
    difficulty: 2,
    ...
    choices: [
      {
        ...
        text: 'Başvuruyu özenle hazırla',
        effect: { money: 120, intelligence: 3, discipline: 2, familyRelation: 2, energy: -4 },
        skillUpdates: { reading: 2, writing: 1 },
        stressEffect: 4,
        feedback: 'Başvurun kabul edildi. Burs ile okul masrafların bir süreliğine rahatlayacak.',
      },
      {
        id: 'econ_scholarship_last_minute',
        text: 'Son gece acele bir dosya gönder',
        effect: { money: 65, intelligence: 1, discipline: -1, energy: -2 },
        stressEffect: 9,
        feedback: 'Evraklar eksik kaldı ama yine de kısıtlı bir destek alabildin.',
      },
    ],
  },
  {
    ...
    text: 'Mahalleden bir abi/abla seni ücretsiz mentor programına davet etti.',
    minAge: 10,
    maxAge: 17,
    rarity: 'UNCOMMON',
    difficulty: 2,
    ...
    choices: [
      {
        ...
        text: 'Programı kabul et, düzenli çalış',
        effect: { money: 90, intelligence: 2, discipline: 3, charisma: 2, familyRelation: 1 },
        skillUpdates: { logic: 1, work_ethic: 2 },
        stressEffect: -4,
        feedback: 'Mentorun hem kaynak buldu hem de plan çıkardı. Yalnız olmadığını hissettin.',
      },
      {
        id: 'econ_mentor_weekend_job',
        text: 'Mentorla hafta sonu mini iş dene',
        effect: { money: 140, discipline: 2, health: -2, energy: -6 },
        skillUpdates: { business: 1, work_ethic: 1 },
        stressEffect: 6,
        feedback: 'Yorucu geçti ama kazanç sağladın ve iş deneyimi edindin.',
      },
    ],
  },
  {
    ...
    text: 'Yerel bir dernek okul ve temel ihtiyaçlar için topluluk destek paketi açıkladı.',
    minAge: 9,
    maxAge: 17,
    rarity: 'UNCOMMON',
    difficulty: 2,
    ...
    choices: [
      {
        ...
        text: 'Desteği kabul et ve odağını derslere ver',
        effect: { money: 110, familyRelation: 4, charisma: 2 },
        stressEffect: -6,
        feedback: 'Topluluk desteği nefes aldırdı. Evdeki gerginlik bir miktar azaldı.',
      },
      {
        id: 'econ_community_giveback',
        text: 'Desteği al ve gönüllü çalışmayla geri öde',
        effect: { money: 80, discipline: 3, charisma: 3, familyRelation: 6, energy: -4 },
        skillUpdates: { teamwork: 2 },
        stressEffect: 2,
        feedback: 'Yardım alırken sahada da çalıştın. Hem destek buldun hem güven kazandın.',
      },
    ],
  },
